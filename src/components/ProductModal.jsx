            ...
            const handleCloseProductModal=()=>{
                ...
                setIsopen(false)
                  ...
                  const UpdateProduct =async ()=>{
                    try {
                      await axios.put(`${import.meta.env.VITE_BASE_URL}/v2/api/${import.meta.env.VITE_API_PATH}/admin/product/${modalData.id}`
                        ,{
                          data:{
                            ...modalData,
                            origin_price: Number(modalData.origin_price),
                  ...
                  const handleUpdateProduct  = async ()=>{
                    ...
                    const handleFileChange = async (e)=>{
                        ...
                        try{
                         const res =  await axios.post(`${import.meta.env.VITE_BASE_URL}/v2/api/${import.meta.env.VITE_API_PATH}/admin/upload`,
                          formData);
